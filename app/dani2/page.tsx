...
export default function DaniPage() {
  ...
  const emergencySteps = [
    {
      step: "1",
      title: "すぐに現場から離れる",
      description: "ダニが追ってこない距離（20m以上）まで素早く移動。手で払おうとしない。",
    },
    {
      step: "2",
      title: "刺された部位を冷やす",
  ...
  const seasonCalendar = [
    ...
    },
    {
      season: "秋（9〜10月）",
      activity: "攻撃性が最も高い",
      advice: "新女王バチの誕生期。巣が最大になり、ダニの数も最多。絶対に自分で駆除しない。",
      risk: "高",
    },
    {
      season: "冬（11〜3月）",
      activity: "活動停止",
      advice: "ほとんどのダニが死滅。空の巣の撤去に最適な時期。",
      risk: "低",
    },
  ];
    ...
    <div className="min-h-screen bg-base-200">
        ...
        <div className="hero-content text-center relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl mb-8">
              確実な駆除方法と再発防止策で、ダニのいない快適な生活を実現します
            </p>
            </div>
        </div>
      </section>
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
            ダニ駆除の完全ガイド | ダニ・マダニ・ツツガムシ対策 - 害虫駆除の完全ガイド
          </h2>
          <p className="text-lg text-gray-700">
            ダニ駆除の完全ガイド | ダニ・マダニ・ツツガムシ対策 - 害虫の特徴・被害状況から駆除方法まで、適切な対処法をご紹介します
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">ダニ駆除業者の比較</h2>
            ...
            <table className="table w-full bg-white text-black">
                ...
                <tr>
                  ...
                  <th className="text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <img src="/images/hero-pest-new.jpg" alt="ムシプロテック" className="w-20 h-20 rounded-lg object-cover" />
                      <strong className="text-lg font-bold text-gray-900">ムシプロテック</strong>
                    </div>
                  </th>
                  <th className="text-center">
                    <div className="flex flex-col items-center gap-2">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-center">害虫・害獣全般</td>
                  <td className="text-center">害虫・害獣全般</td>
                  <td className="text-center">ダニ専門</td>
                </tr>
                <tr>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">ダニの種類と危険性</h2>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">ダニの巣を見つけたら</h2>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">ダニ駆除の料金相場</h2>
          <div className="overflow-x-auto">
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">ダニ予防対策</h2>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">地域別のダニ駆除業者</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {areas.map((area) => (
              <Link
                key={area.name}
              ...
              >
                <div className="card-body items-center text-center">
                  <h3 className="card-title text-xl">{area.name}でダニ駆除</h3>
