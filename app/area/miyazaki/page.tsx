...
export const metadata: Metadata = {
  title: "宮崎の害虫駆除業者比較 | 料金相場・口コミ・おすすめ10社",
  description: "宮崎の害虫駆除業者10社を料金・サービス・口コミで徹底比較。地域別の料金相場、害虫カレンダー、信頼できる業者の選び方を詳しく解説。即日対応可能な業者も掲載。",
  openGraph: {
    title: "宮崎の害虫駆除業者比較 | 料金相場・口コミ・おすすめ10社",
    description: "宮崎の害虫駆除業者10社を料金・サービス・口コミで徹底比較。",
    url: "https://pest-control-001.pages.dev/area/miyazaki",
  },
};
...
export default function TokyoPage() {
  const topPests = [
    {
      ...
      name: "ゴキブリ",
      icon: "🪳",
      description: "繁華街や飲食店が多い宮崎では、ゴキブリ被害が最も多い。特にチャバネゴキブリが問題。",
  ...
  const priceComparison = [
    {
      pest: "シロアリ駆除",
      miyazaki: "12,000〜18,000円/坪",
      national: "10,000〜15,000円/坪",
      note: "都心部はやや高め",
    },
    {
      pest: "ハチ駆除",
      miyazaki: "15,000〜35,000円",
      national: "15,000〜30,000円",
      note: "高所作業が多く料金高め",
    },
    {
      pest: "ゴキブリ駆除",
      miyazaki: "20,000〜35,000円",
      national: "15,000〜30,000円",
      note: "飲食店需要で料金やや高",
    },
    {
      pest: "ネズミ駆除",
      miyazaki: "100,000〜180,000円",
      national: "80,000〜150,000円",
      note: "複雑な建物構造で高額",
    },
    {
      pest: "コウモリ駆除",
      miyazaki: "120,000〜350,000円",
...
{/* パンくずリスト */}
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700">
            宮崎都内の害虫駆除業者と料金相場を徹底比較。23区・多摩地域別の特徴と信頼できる業者の選び方をご紹介します。
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">宮崎で多い害虫トップ5</h2>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">宮崎のおすすめ害虫駆除業者比較</h2>
          ...
          <h2 className="heading-primary text-center mt-16 mb-8">宮崎のおすすめ害虫駆除業者 詳細紹介</h2>
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-warning badge-lg">👑 1</span>
                <h3 className="text-2xl font-bold text-black">駆除ザウルス（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=駆除ザウルス+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    創業20年の実績があり、宮崎都内の害虫駆除に精通したスタッフが来てくれました。10年保証も心強いです。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg" style={{backgroundColor: '#C0C0C0', color: '#000'}}>👑 2</span>
                <h3 className="text-2xl font-bold text-black">害獣駆除のROY（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=害獣駆除のROY+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    一級建築士事務所ということで、宮崎の複雑な建物構造を熟知した的確な施工をしていただけました。業界最安値水準でコスパも最高です。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                ...
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    宮崎都内全域に対応しているので、地方でも迅速に対応していただけました。見積もりも明確で、追加料金もなく信頼できました。
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg" style={{backgroundColor: '#CD7F32', color: '#fff'}}>👑 3</span>
                <h3 className="text-2xl font-bold text-black">害獣BUZZ（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=害獣BUZZ+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                ...
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    最短30分で来ていただけて、緊急時の対応が素早かったです。宮崎都内の害虫駆除に精通した的確な施工でした。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg">4</span>
                <h3 className="text-2xl font-bold text-black">サンキョークリーンサービス（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=サンキョークリーンサービス+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    創業28年のベテラン業者だけあって、経験豊富なスタッフが来てくれました。宮崎都内の害虫駆除に精通した的確な施工でした。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                ...
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    全国対応で、宮崎都内でも迅速に対応していただけました。施工後のフォローも丁寧でした。
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg">5</span>
                <h3 className="text-2xl font-bold text-black">ハウスプロテクト（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=ハウスプロテクト+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg">6</span>
                <h3 className="text-2xl font-bold text-black">害虫駆除110番（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=害虫駆除110番+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                ...
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    全国対応で、宮崎都内でも迅速に対応していただけました。24時間365日受付で、緊急時にもすぐに連絡できました。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg">7</span>
                <h3 className="text-2xl font-bold text-black">害獣プロテック（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=害獣プロテック+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    50年以上の経験があるベテラン業者だけあって、宮崎都内の害虫駆除に精通した的確な施工でした。10年保証も心強いです。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    工務店歴50年で建物構造を熟知しているため、複雑な宮崎の建物でも適切な対応をしていただけました。最短30分で来ていただけて助かりました。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    広範囲のエリアに対応しているので、宮崎都内でも安心です。施工後のアフターフォローも丁寧でした。
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg">8</span>
                <h3 className="text-2xl font-bold text-black">ラッター（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=ラッター+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    累計3万件以上の実績があり、経験豊富なスタッフが来てくれました。宮崎都内の害虫駆除に精通した的確な施工でした。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg">9</span>
                <h3 className="text-2xl font-bold text-black">EMEAO!（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=EMEAO!+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                ...
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    全国対応で、宮崎都内でも優良業者を紹介していただけました。業者選びに迷った時に便利なサービスです。
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg">10</span>
                <h3 className="text-2xl font-bold text-black">ダスキン（宮崎）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=ダスキン+宮崎+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                ...
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    16,500円からという良心的な料金設定で、全国対応なので宮崎都内でも安心です。見積もりも明確で、追加料金もなく信頼できました。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">宮崎の害虫駆除料金相場</h2>
          <div className="overflow-x-auto">
            <table className="table w-full bg-white text-black shadow-xl border border-gray-300">
              <thead>
                <tr>
                  ...
                  <th className="bg-gray-800 text-white border border-gray-300">宮崎の相場</th>
              ...
              <tbody>
                {priceComparison.map((row, idx) => (
                  <tr key={idx}>
                    ...
                    <td className="text-primary font-semibold border border-gray-300">{row.miyazaki}</td>
          ...
          <div className="alert alert-info mt-8">
            ...
            <div>
              <h3 className="font-bold">宮崎の料金が高い理由</h3>
              <p className="text-sm">
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">宮崎の害虫カレンダー</h2>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">宮崎都内の害虫駆除業者エリア</h2>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">宮崎都の害虫相談窓口</h2>
          <div className="space-y-4">
