...
export const metadata: Metadata = {
  ...
  description: "埼玉の害虫駆除業者10社を料金・サービス・口コミで徹底比較。地域別の料金相場、害虫カレンダー、信頼できる業者の選び方を詳しく解説。即日対応可能な業者も掲載。",
  openGraph: {
    title: "埼玉の害虫駆除業者比較 | 料金相場・口コミ・おすすめ10社",
