      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700">
            ハチの特徴・被害状況から駆除方法まで、適切な対処法をご紹介します
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
                ...
                <tr>
                  ...
                  <th className="text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <img src="/images/companies/hachi-otasuke.png" alt="ハチお助け本舗" className="w-20 h-20 rounded-lg object-cover" />
                      <strong className="text-lg font-bold text-gray-900">ハチお助け本舗</strong>
                    </div>
                  </th>
                </tr>
              </thead>
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              ...
              <img src="/images/companies/hachi-otasuke.png" alt="ハチお助け本舗" className="w-full h-48 object-cover rounded-lg" />
            </div>
