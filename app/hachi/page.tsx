        ...
        <div className="max-w-7xl mx-auto">
                ...
                <tr>
                  ...
                  <th className="text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <img src="/images/companies/hachi-otasuke.jpg" alt="ハチお助け本舗" className="w-20 h-20 rounded-full object-cover" />
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              ...
              <img src="/images/companies/hachi-otasuke.jpg" alt="ハチお助け本舗" className="w-full h-48 object-cover rounded-lg" />
            </div>
