...
export const metadata: Metadata = {
  title: "名古屋のシロアリ駆除業者おすすめ10社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "名古屋でシロアリ駆除業者をお探しなら当サイト。料金相場9,000〜14,000円/坪。名古屋市、愛知県内対応の優良業者を口コミ・実績で徹底比較。見積もり無料。",
  openGraph: {
    title: "名古屋のシロアリ駆除業者おすすめ10社｜料金相場・口コミ比較",
    description: "名古屋のシロアリ駆除業者を料金・サービス・口コミで徹底比較。名古屋市、愛知県内対応。",
    ...
    <div className="min-h-screen bg-base-200">
      ...
      <section className="py-8 px-4 bg-amber-50">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl font-bold text-gray-900">
            名古屋市、愛知県内対応｜シロアリ駆除の専門業者10社を徹底比較
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">名古屋のおすすめシロアリ駆除業者比較</h2>
            ...
            <table className="table w-full bg-white text-black">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="text-center">名古屋市、愛知県内</td>
                  <td className="text-center">名古屋市、愛知県内</td>
                  <td className="text-center">名古屋全域</td>
                </tr>
                <tr>
                  <th className="bg-gray-800 text-white border border-gray-300">料金目安</th>
                  <td className="text-center font-semibold text-primary">9,000〜14,000円/坪</td>
                  <td className="text-center font-semibold text-primary">9,000〜14,000円/坪</td>
                  <td className="text-center font-semibold text-primary">9,000〜14,000円/坪</td>
                </tr>
                <tr>
      ...
      <section className="py-12 px-4 bg-base-100">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center">名古屋で多い害虫TOP5</h2>
