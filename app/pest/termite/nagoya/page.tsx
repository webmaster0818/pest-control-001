...
export const metadata: Metadata = {
  title: "名古屋のシロアリ駆除業者おすすめ8社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "名古屋でシロアリ駆除業者をお探しなら当サイト。おすすめ業者8社を料金・サービス・口コミで徹底比較。見積もり無料。",
  openGraph: {
    title: "名古屋のシロアリ駆除業者おすすめ8社｜料金相場・口コミ比較",
    description: "名古屋のシロアリ駆除業者を料金・サービス・口コミで徹底比較。",
    url: "https://pest-control-001.pages.dev/pest/termite/nagoya",
  },
};

export default function TermiteNagoyaPage() {
  const topPests = [
    {
      rank: 1,
      name: "ゴキブリ",
...
{/* パンくずリスト */}
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">名古屋のシロアリ駆除料金相場</h2>
          <div className="overflow-x-auto">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">名古屋都内のエリア別シロアリ駆除業者</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">中村区</p>
            ...
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">熱田区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">千種区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">東区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
