...
export const metadata: Metadata = {
  title: "東京のシロアリ駆除業者比較 | 料金相場・口コミ・おすすめ8社",
  description: "東京のシロアリ駆除業者8社を料金・サービス・口コミで徹底比較。23区・多摩地域の料金相場、害虫カレンダー、信頼できる業者の選び方を詳しく解説。即日対応可能な業者も掲載。",
  openGraph: {
    title: "東京のシロアリ駆除業者比較 | 料金相場・口コミ・おすすめ8社",
    description: "東京のシロアリ駆除業者8社を料金・サービス・口コミで徹底比較。",
    url: "https://pest-control-001.pages.dev/pest/termite/tokyo",
  },
};
...
export default function TokyoPage() {
  ...
  const seasonCalendar = [
    {
      season: "春（3月〜5月）",
      pests: ["羽アリ発生ピーク", "巣の活動開始", "被害拡大注意"],
      advice: "羽アリを見かけたら即座に点検を。この時期の発見が最も多い。",
    },
    {
      season: "夏（6月〜8月）",
      pests: ["活動活発化", "梅雨時期の湿気で繁殖", "被害拡大加速"],
      advice: "梅雨時期の湿気で活動が活発化。被害拡大に注意。",
    },
    {
      season: "秋（9月〜11月）",
      pests: ["巣の拡大期", "越冬準備", "二次被害リスク"],
      advice: "冬に向けて巣を拡大する時期。早期発見・駆除が重要。",
    },
    {
      season: "冬（12月〜2月）",
      pests: ["活動低下", "駆除適期", "予防施工に最適"],
...
{/* パンくずリスト */}
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">東京のおすすめシロアリ駆除業者比較</h2>
          ...
          <h2 className="heading-primary text-center mt-16 mb-8">東京のおすすめシロアリ駆除業者 詳細紹介</h2>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">東京のシロアリ駆除料金相場</h2>
          <div className="overflow-x-auto">
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">東京のシロアリカレンダー</h2>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">東京都内のシロアリ駆除業者エリア</h2>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">東京都内のエリア別シロアリ駆除業者</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">新宿区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">渋谷区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">港区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">世田谷区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">大田区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">練馬区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">江戸川区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
            <div className="bg-base-100 hover:bg-amber-50 border-2 border-gray-200 rounded-lg py-4 px-2 text-center transition-all">
              <p className="text-gray-900 font-semibold">足立区</p>
              <p className="text-xs text-gray-600">準備中</p>
            </div>
          </div>
        </div>
