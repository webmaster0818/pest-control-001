...
export const metadata: Metadata = {
  title: "東京のシロアリ駆除業者おすすめ10社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "東京でシロアリ駆除業者をお探しなら当サイト。料金相場12,000〜18,000円/坪。23区・多摩地域対応の優良業者を口コミ・実績で徹底比較。見積もり無料。",
  openGraph: {
    title: "東京のシロアリ駆除業者おすすめ10社｜料金相場・口コミ比較",
    description: "東京のシロアリ駆除業者を料金・サービス・口コミで徹底比較。23区・多摩地域対応。",
    url: "https://pest-control-001.pages.dev/pest/termite/tokyo",
  },
};

export default function TermiteTokyoPage() {
  const priceTable = [
  ...
  return (
    <div className="min-h-screen bg-base-200">
        ...
        <div className="hero-content text-center relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-xl mb-8">
              確実な駆除方法と再発防止策で、シロアリのいない快適な生活を実現します
            </p>
      ...
      <section className="py-8 px-4 bg-amber-50">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl font-bold text-gray-900">
            東京23区・多摩地域対応｜シロアリ駆除の専門業者10社を徹底比較
          </p>
        </div>
      </section>
            ...
            <table className="table w-full bg-white text-black">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="text-center">東京23区、多摩地域</td>
                  <td className="text-center">東京23区、多摩地域</td>
                  <td className="text-center">東京全域</td>
                </tr>
                <tr>
                  <th className="bg-gray-800 text-white border border-gray-300">料金目安</th>
                  <td className="text-center font-semibold text-primary">12,000円/坪〜</td>
                  <td className="text-center font-semibold text-primary">13,500円/坪〜</td>
                  <td className="text-center font-semibold text-primary">11,000円/坪〜</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="text-sm">日本しろあり対策協会認定、バリア工法・ベイト工法両対応</td>
                  <td className="text-sm">最新ベイト工法専門、環境配慮型</td>
      ...
      <section className="py-12 px-4 bg-base-100">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center">東京で多い害虫TOP5</h2>
