...
export const metadata: Metadata = {
  title: "大阪のシロアリ駆除業者おすすめ10社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "大阪でシロアリ駆除業者をお探しなら当サイト。料金相場10,000〜16,000円/坪。大阪市、堺市、北摂エリア対応の優良業者を口コミ・実績で徹底比較。見積もり無料。",
  openGraph: {
    title: "大阪のシロアリ駆除業者おすすめ10社｜料金相場・口コミ比較",
    description: "大阪のシロアリ駆除業者を料金・サービス・口コミで徹底比較。大阪市、堺市、北摂エリア対応。",
    ...
    <div className="min-h-screen bg-base-200">
      ...
      <section className="py-8 px-4 bg-amber-50">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl font-bold text-gray-900">
            大阪市、堺市、北摂エリア対応｜シロアリ駆除の専門業者10社を徹底比較
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">大阪のおすすめシロアリ駆除業者比較</h2>
            ...
            <table className="table w-full bg-white text-black">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-center font-semibold text-primary">10,000〜16,000円/坪</td>
                  <td className="text-center font-semibold text-primary">10,000〜16,000円/坪</td>
                  <td className="text-center font-semibold text-primary">10,000〜16,000円/坪</td>
                </tr>
                <tr>
