...
export const metadata: Metadata = {
  title: "東京のハチ駆除業者おすすめ8社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "東京でハチ駆除業者をお探しなら当サイト。おすすめ業者8社を料金・サービス・口コミで徹底比較。見積もり無料。",
  openGraph: {
    title: "東京のハチ駆除業者おすすめ8社｜料金相場・口コミ比較",
    description: "東京のハチ駆除業者を料金・サービス・口コミで徹底比較。",
    url: "https://pest-control-001.pages.dev/pest/wasp/tokyo",
  },
};

export default function WaspTokyoPage() {
  const topPests = [
    {
      rank: 1,
      name: "ゴキブリ",
  ...
  const priceComparison = [
    {
      area: "東京23区",
      price: "15,000〜35,000円/件",
      note: "高所作業多く高め",
    },
    {
      area: "多摩地域",
      price: "12,000〜28,000円/件",
      note: "標準的",
    },
    {
      area: "全国平均",
      price: "12,000〜30,000円/件",
      note: "参考値",
    },
  ];
  ...
  const seasonCalendar = [
    {
      season: "春（3月〜5月）",
      pests: ["巣作り開始"],
      advice: "女王バチが巣作りを開始。小さいうちに駆除を。",
    },
    {
      season: "夏（6月〜8月）",
      pests: ["巣の拡大期"],
      advice: "働きバチが増加し、巣が急速に拡大。専門業者に依頼を。",
    },
    {
      season: "秋（9月〜11月）",
      pests: ["攻撃性ピーク"],
      advice: "最も危険な時期。巣に近づかず、プロに任せるべき。",
    },
    {
      season: "冬（12月〜2月）",
      pests: ["活動休止"],
      advice: "働きバチが死滅。空き巣の撤去と来春の予防対策を。",
    },
  ];
...
{/* パンくずリスト */}
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">東京のハチ駆除料金相場</h2>
          <div className="overflow-x-auto">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">東京都内のエリア別ハチ駆除業者</h2>
          <p className="text-center text-gray-700 mb-8">
            お住まいのエリアでハチ駆除業者を探す（準備中）
          </p>
