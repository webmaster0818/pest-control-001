...
export const metadata: Metadata = {
  title: "神奈川のゴキブリ駆除業者おすすめ8社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "神奈川でゴキブリ駆除業者をお探しなら当サイト。おすすめ業者8社を料金・サービス・口コミで徹底比較。見積もり無料。",
  openGraph: {
    title: "神奈川のゴキブリ駆除業者比較 | 料金相場・口コミ・おすすめ10社",
    description: "神奈川のゴキブリ駆除業者10社を料金・サービス・口コミで徹底比較。",
    url: "https://pest-control-001.pages.dev/area/kanagawa",
  },
};

export default function CockroachKanagawaPage() {
  const topPests = [
    {
      rank: 1,
      name: "ゴキブリ",
...
{/* パンくずリスト */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg">6</span>
                <h3 className="text-2xl font-bold text-black">害虫・害獣駆除プロ比較ナビ（神奈川）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=害虫・害獣駆除プロ比較ナビ+神奈川+害虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">神奈川のゴキブリ駆除料金相場</h2>
          <div className="overflow-x-auto">
