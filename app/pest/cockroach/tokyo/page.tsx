...
export const metadata: Metadata = {
  title: "東京のゴキブリ駆除業者おすすめ10社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "東京でゴキブリ駆除業者をお探しなら当サイト。料金相場8,000〜12,000円/件。東京23区、多摩地域対応の優良業者を口コミ・実績で徹底比較。見積もり無料。",
  openGraph: {
    title: "東京のゴキブリ駆除業者おすすめ10社｜料金相場・口コミ比較",
    description: "東京のゴキブリ駆除業者を料金・サービス・口コミで徹底比較。東京23区、多摩地域対応。",
    ...
    <div className="min-h-screen bg-base-200">
      ...
      <section className="py-8 px-4 bg-amber-50">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl font-bold text-gray-900">
            東京23区、多摩地域対応｜ゴキブリ駆除の専門業者10社を徹底比較
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">東京のおすすめゴキブリ駆除業者比較</h2>
            ...
            <table className="table w-full bg-white text-black">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-center font-semibold text-primary">8,000〜12,000円/件</td>
                  <td className="text-center font-semibold text-primary">8,000〜12,000円/件</td>
                  <td className="text-center font-semibold text-primary">8,000〜12,000円/件</td>
                </tr>
                <tr>
