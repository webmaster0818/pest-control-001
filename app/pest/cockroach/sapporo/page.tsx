...
export const metadata: Metadata = {
  title: "札幌のゴキブリ駆除業者おすすめ8社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "札幌でゴキブリ駆除業者をお探しなら当サイト。おすすめ業者8社を料金・サービス・口コミで徹底比較。見積もり無料。",
  openGraph: {
...
export default function CockroachSapporoPage() {
  const topPests = [
    {
      rank: 1,
      name: "ゴキブリ",
