...
export const metadata: Metadata = {
  title: "横浜のゴキブリ駆除業者おすすめ10社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "横浜でゴキブリ駆除業者をお探しなら当サイト。料金相場7,500〜11,500円/件。横浜市全域、川崎市対応の優良業者を口コミ・実績で徹底比較。見積もり無料。",
  openGraph: {
    title: "横浜のゴキブリ駆除業者おすすめ10社｜料金相場・口コミ比較",
    description: "横浜のゴキブリ駆除業者を料金・サービス・口コミで徹底比較。横浜市全域、川崎市対応。",
    ...
    <div className="min-h-screen bg-base-200">
      ...
      <section className="py-8 px-4 bg-amber-50">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-2xl font-bold text-gray-900">
            横浜市全域、川崎市対応｜ゴキブリ駆除の専門業者10社を徹底比較
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">横浜のおすすめゴキブリ駆除業者比較</h2>
            ...
            <table className="table w-full bg-white text-black">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-center font-semibold text-primary">7,500〜11,500円/件</td>
                  <td className="text-center font-semibold text-primary">7,500〜11,500円/件</td>
                  <td className="text-center font-semibold text-primary">7,500〜11,500円/件</td>
                </tr>
                <tr>
