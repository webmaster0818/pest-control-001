...
export const metadata: Metadata = {
  title: "名古屋のゴキブリ駆除業者おすすめ8社｜料金相場・口コミ比較 - 害虫・害獣駆除プロ比較ナビ",
  description: "名古屋でゴキブリ駆除業者をお探しなら当サイト。おすすめ業者8社を料金・サービス・口コミで徹底比較。見積もり無料。",
  openGraph: {
    title: "名古屋のゴキブリ駆除業者おすすめ8社｜料金相場・口コミ比較",
    description: "名古屋のゴキブリ駆除業者を料金・サービス・口コミで徹底比較。",
    url: "https://pest-control-001.pages.dev/pest/cockroach/nagoya",
  },
};

export default function CockroachNagoyaPage() {
  const topPests = [
    {
      rank: 1,
      name: "ゴキブリ",
...
{/* パンくずリスト */}
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">名古屋のゴキブリ駆除料金相場</h2>
          <div className="overflow-x-auto">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">名古屋都内のエリア別ゴキブリ駆除業者</h2>
