...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "毛虫駆除業者比較 | スズメバチ・アシナガバチの料金相場",
    description: "毛虫駆除業者10社を料金・対応速度・実績で徹底比較。即日対応可能な業者も掲載。",
...
export default function KemushiPage() {
  ...
  const emergencySteps = [
    {
      step: "1",
      title: "すぐに現場から離れる",
      description: "毛虫が追ってこない距離（20m以上）まで素早く移動。手で払おうとしない。",
    },
    {
      step: "2",
      title: "刺された部位を冷やす",
  ...
  const seasonCalendar = [
    ...
    },
    {
      season: "秋（9〜10月）",
      activity: "攻撃性が最も高い",
      advice: "新女王バチの誕生期。巣が最大になり、毛虫の数も最多。絶対に自分で駆除しない。",
      risk: "高",
    },
    {
      season: "冬（11〜3月）",
      activity: "活動停止",
      advice: "ほとんどの毛虫が死滅。空の巣の撤去に最適な時期。",
      risk: "低",
    },
  ];
    ...
    <div className="min-h-screen bg-base-200">
        ...
        <div className="hero-content text-center relative z-10">
          <div className="max-w-3xl">
            ...
            <div className="alert alert-error shadow-lg max-w-2xl mx-auto">
              ...
              <span className="font-bold">緊急：毛虫の巣を見つけたら絶対に自分で駆除しないでください</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-7xl mx-auto">
            ...
            <table className="table w-full bg-white text-black">
                ...
                <tr>
                  ...
                  <th className="text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=100&h=100&fit=crop" alt="毛虫お助け本舗" className="w-20 h-20 rounded-full object-cover" />
                      <strong>毛虫お助け本舗</strong>
                    </div>
                  </th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td className="text-center">害虫・害獣全般</td>
                  <td className="text-center">害虫・害獣全般</td>
                  <td className="text-center">毛虫専門</td>
                </tr>
                <tr>
          ...
          <h2 className="heading-primary text-center mt-16 mb-8">おすすめ毛虫駆除業者 詳細紹介</h2>
            ...
            <div className="mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  ...
                  <p className="text-sm text-gray-900">
                    24時間対応というのが本当に助かりました。夜間に毛虫に遭遇してパニックになりましたが、すぐに駆けつけてくれて安心しました。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <div className="flex items-center gap-2 mb-2">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社アサンテ+毛虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=有限会社北日本消毒+毛虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社あい営繕+毛虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社ミヤコ消毒+毛虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社こだま+毛虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=大洋防疫研究所+毛虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社第一環研+毛虫駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base">9</span>
                <h3 className="text-2xl font-bold text-black">毛虫お助け本舗（毛虫駆除専門）</h3>
              </div>
              <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=400&h=200&fit=crop" alt="毛虫お助け本舗" className="w-full h-48 object-cover rounded-lg" />
            </div>

            <div className="mb-6">
              <h4 className="font-bold text-lg text-black mb-3">毛虫お助け本舗の特徴</h4>
              <ul className="list-disc list-inside space-y-2 text-gray-900">
            ...
            <div className="mb-6">
              <h4 className="font-bold text-lg text-black mb-3">◆毛虫お助け本舗の基本情報</h4>
              <div className="overflow-x-auto">
                <table className="table w-full bg-white text-black">
                  <tbody>
                    <tr>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-bold text-lg text-black">◆毛虫お助け本舗の口コミ</h4>
                <a href="https://www.google.com/search?q=毛虫お助け本舗+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    24時間365日対応で、深夜に毛虫に遭遇してパニックになったときもすぐに駆けつけてくれました。最短10分で来てくれるのは本当に助かります。
                  </p>
                </div>
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                ...
                <div className="border-2 border-base-200 p-4 rounded-lg bg-base-50">
                  <p className="text-sm text-gray-900">
                    毛虫専門の業者さんなので、技術力が高く、安全かつ迅速に駆除してくれました。再発保証もあり、安心してお任せできました。
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">毛虫の種類と危険性</h2>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">毛虫の巣を見つけたら</h2>
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">毛虫駆除の料金相場</h2>
          <div className="overflow-x-auto">
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">季節別毛虫対策カレンダー</h2>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center">地域別の毛虫駆除業者</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {areas.map((area) => (
              <Link
                key={area.name}
              ...
              >
                <div className="card-body items-center text-center">
                  <h3 className="card-title text-xl">{area.name}で毛虫駆除</h3>
