        ...
        <div className="max-w-7xl mx-auto">
                ...
                <tr>
                  ...
                  <th className="text-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=100&h=100&fit=crop" alt="トコジラミお助け本舗" className="w-20 h-20 rounded-full object-cover" />
                      <strong>トコジラミお助け本舗</strong>
                    </div>
                  </th>
                </tr>
              </thead>
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                ...
                <h3 className="text-2xl font-bold text-black">株式会社三共消毒（トコジラミ駆除）</h3>
              </div>
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base" style={{backgroundColor: '#C0C0C0', color: '#000'}}>👑 2</span>
                <h3 className="text-2xl font-bold text-black">株式会社アサンテ（トコジラミ駆除）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社アサンテ+トコジラミ駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base" style={{backgroundColor: '#CD7F32', color: '#fff'}}>👑 3</span>
                <h3 className="text-2xl font-bold text-black">有限会社北日本消毒（トコジラミ駆除）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=有限会社北日本消毒+トコジラミ駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base">4</span>
                <h3 className="text-2xl font-bold text-black">株式会社あい営繕（トコジラミ駆除）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社あい営繕+トコジラミ駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base">5</span>
                <h3 className="text-2xl font-bold text-black">株式会社ミヤコ消毒（トコジラミ駆除）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社ミヤコ消毒+トコジラミ駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base">6</span>
                <h3 className="text-2xl font-bold text-black">株式会社こだま（トコジラミ駆除）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社こだま+トコジラミ駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base">7</span>
                <h3 className="text-2xl font-bold text-black">大洋防疫研究所（トコジラミ駆除）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=大洋防疫研究所+トコジラミ駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base">8</span>
                <h3 className="text-2xl font-bold text-black">株式会社第一環研（トコジラミ駆除）</h3>
              </div>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <a href="https://www.google.com/search?q=株式会社第一環研+トコジラミ駆除+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
          ...
          <div className="mb-16 bg-white shadow-lg rounded-lg p-8 company-detail">
            <div className="mb-4">
              <div className="flex items-center gap-3 mb-3 flex-wrap">
                <span className="badge badge-lg text-base">9</span>
                <h3 className="text-2xl font-bold text-black">トコジラミお助け本舗（トコジラミ駆除専門）</h3>
              </div>
              <img src="https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=400&h=200&fit=crop" alt="トコジラミお助け本舗" className="w-full h-48 object-cover rounded-lg" />
            </div>

            <div className="mb-6">
              <h4 className="font-bold text-lg text-black mb-3">トコジラミお助け本舗の特徴</h4>
              <ul className="list-disc list-inside space-y-2 text-gray-900">
            ...
            <div className="mb-6">
              <h4 className="font-bold text-lg text-black mb-3">◆トコジラミお助け本舗の基本情報</h4>
              <div className="overflow-x-auto">
                <table className="table w-full bg-white text-black">
                  <tbody>
                    <tr>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-3">
                <h4 className="font-bold text-lg text-black">◆トコジラミお助け本舗の口コミ</h4>
                <a href="https://www.google.com/search?q=トコジラミお助け本舗+口コミ" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm">
                  Google口コミを見る →
                </a>
              </div>
              <div className="space-y-4">
