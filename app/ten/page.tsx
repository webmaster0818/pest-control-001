...
export const metadata: Metadata = {
  title: "テン駆除業者比較 | 天井裏被害の料金相場と対策方法",
  description: "テン駆除業者10社を料金・実績・対応速度で徹底比較。テン駆除料金相場（90,000円〜280,000円）、鳥獣保護法対応、天井裏の騒音・糞尿対策を詳しく解説。",
  openGraph: {
    title: "テン駆除業者比較 | 天井裏被害の料金相場と対策方法",
    description: "テン駆除業者10社を料金・実績・対応速度で徹底比較。テン駆除料金相場（90,000円〜280,000円）、鳥獣保護法対応、天井裏の騒音・糞尿対策を詳しく解説。",
    url: "https://pest-control-001.pages.dev/ten",
  },
};
    ...
    <div className="min-h-screen bg-base-200">
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700">
            テンの特徴・被害状況から駆除方法まで、適切な対処法をご紹介します
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-base-100">
        <div className="max-w-7xl mx-auto">
          <h2 className="heading-primary text-center mb-8">テン駆除業者の比較</h2>
                    ...
                    <div className="space-y-3">
                      <div className="bg-base-200 p-4 rounded-lg">
                        ...
                        <p className="text-gray-300 text-sm">
                          迅速に対応していただき、テンの被害がすぐに解決しました。料金も明確で安心できました。
                        </p>
                      </div>
                      <div className="bg-base-200 p-4 rounded-lg">
                        <div className="flex items-center gap-2 mb-2">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center mb-8">テン駆除の料金相場</h2>
            ...
            <table className="table w-full bg-white text-black">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="bg-white text-black border border-gray-300">90,000〜280,000円</td>
                </tr>
                <tr>
      ...
      <section className="py-16 px-4 bg-green-500 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">テン駆除のご相談は今すぐ無料で</h2>
