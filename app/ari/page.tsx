...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "アリ駆除業者比較 | イエヒメアリ・ルリアリの料金相場と対策方法",
    description: "アリ駆除業者10社を料金・実績・対応速度で徹底比較。イエヒメアリ、ルリアリの駆除料金相場（10,000円〜30,000円）、侵入経路対策、季節別アリ対策カレンダーを詳しく解説。",
    url: "https://pest-control-001.pages.dev/ari",
  },
};
    ...
    <div className="min-h-screen bg-base-200">
                    ...
                    <div className="space-y-3">
                      <div className="bg-base-200 p-4 rounded-lg">
                        ...
                        <p className="text-gray-300 text-sm">
                          迅速に対応していただき、アリの被害がすぐに解決しました。料金も明確で安心できました。
                        </p>
                      </div>
                      <div className="bg-base-200 p-4 rounded-lg">
                        <div className="flex items-center gap-2 mb-2">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center mb-8">アリ駆除の料金相場</h2>
      ...
      <section className="py-16 px-4 bg-green-500 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">アリ駆除のご相談は今すぐ無料で</h2>
