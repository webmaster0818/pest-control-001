...
export const metadata: Metadata = {
  alternates: { canonical: "/nezumi" },
  title: "ネズミ駆除の完全ガイド | 確実な駆除と再発防止 - 害虫・害獣駆除プロ比較ナビ",
      ...
      <section className="py-8 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
            ネズミ駆除の完全ガイド | 確実な駆除と再発防止 - 害虫駆除の完全ガイド
          </h2>
          <p className="text-lg text-gray-700">
            ネズミ駆除の完全ガイド | 確実な駆除と再発防止 - 害虫の特徴・被害状況から駆除方法まで、適切な対処法をご紹介します
          </p>
        </div>
      </section>
                ...
                <table className="table w-full bg-white text-black border border-gray-300">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="bg-white text-black border border-gray-300">ネズミ・コウモリ・イタチなど害獣全般</td>
                    </tr>
                    <tr>
