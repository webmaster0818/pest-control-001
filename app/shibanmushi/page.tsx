...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "シバンムシ駆除業者比較 | 畳・木材食害の料金相場と対策",
    description: "シバンムシ駆除業者10社を料金・実績・対応速度で徹底比較。シバンムシ駆除料金相場（15,000円〜40,000円）、畳・木材の食害対策、発生源特定方法を詳しく解説。",
    url: "https://pest-control-001.pages.dev/shibanmushi",
  },
};
    ...
    <div className="min-h-screen bg-base-200">
                    ...
                    <div className="space-y-3">
                      <div className="bg-base-200 p-4 rounded-lg">
                        ...
                        <p className="text-gray-300 text-sm">
                          迅速に対応していただき、シバンムシの被害がすぐに解決しました。料金も明確で安心できました。
                        </p>
                      </div>
                      <div className="bg-base-200 p-4 rounded-lg">
                        <div className="flex items-center gap-2 mb-2">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center mb-8">シバンムシ駆除の料金相場</h2>
            ...
            <table className="table w-full bg-white text-black">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="bg-white text-black border border-gray-300">15,000〜40,000円</td>
                </tr>
                <tr>
      ...
      <section className="py-16 px-4 bg-green-500 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">シバンムシ駆除のご相談は今すぐ無料で</h2>
          <p className="text-xl mb-8">
            専門業者があなたのシバンムシ被害を解決します
          </p>
