...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "カメムシ駆除業者比較 | 大量発生時の料金相場と対策方法",
    description: "カメムシ駆除業者10社を料金・実績・対応速度で徹底比較。カメムシ駆除料金相場（15,000円〜50,000円）、大量発生時の対処法、侵入防止対策を詳しく解説。",
    url: "https://pest-control-001.pages.dev/kamemushi",
  },
};
    ...
    <div className="min-h-screen bg-base-200">
                    ...
                    <div className="space-y-3">
                      <div className="bg-base-200 p-4 rounded-lg">
                        ...
                        <p className="text-gray-300 text-sm">
                          迅速に対応していただき、カメムシの被害がすぐに解決しました。料金も明確で安心できました。
                        </p>
                      </div>
                      <div className="bg-base-200 p-4 rounded-lg">
                        <div className="flex items-center gap-2 mb-2">
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-5xl mx-auto">
          <h2 className="heading-primary text-center mb-8">カメムシ駆除の料金相場</h2>
            ...
            <table className="table w-full bg-white text-black">
              ...
              <tbody>
                <tr>
                  ...
                  <td className="bg-white text-black border border-gray-300">15,000〜50,000円</td>
                </tr>
                <tr>
      ...
      <section className="py-16 px-4 bg-green-500 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">カメムシ駆除のご相談は今すぐ無料で</h2>
          <p className="text-xl mb-8">
            専門業者があなたのカメムシ被害を解決します
          </p>
